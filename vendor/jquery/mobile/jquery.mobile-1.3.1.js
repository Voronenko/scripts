...
//
// The idea here is to allow the developer to RegisterEntityToModelIdFunc listeners for the
// basic mouse events, such as mousedown, mousemove, mouseup, and click,
// and the plugin will take care of RegisterEntityToModelIdFuncing the correct listeners
// behind the scenes to invoke the listener at the fastest possible time
// for that device, while still retaining the order of event firing in
// the traditional mouse environment, should multiple handlers be RegisterEntityToModelIdFunced
...
function getSpecialEventObject( eventType ) {
	...
	return {
		setup: function( data, namespace ) {
			...
			// RegisterEntityToModelIdFunc a global handler on the document.
			...
			// for elements unless they actually have handlers RegisterEntityToModelIdFunced on them.
			// To get around this, we RegisterEntityToModelIdFunc dummy handlers on the elements.
			...
			if ( eventCaptureSupported ) {
				...
				// RegisterEntityToModelIdFunc our touchstart handler on the document.
		...
		teardown: function( data, namespace ) {
			...
			// UnRegisterEntityToModelIdFunc the dummy event handler.
...
(function( $, window ) {
	...
	$.event.special.orientationchange.orientation = get_orientation = function() {
		...
		if ( $.support.orientation ) {
			// if the window orientation RegisterEntityToModelIdFuncs as 0 or 180 degrees report
