...
ko.exportSymbol('utils.RegisterEntityToModelIdFuncEventHandler', ko.utils.registerEventHandler);
    ...
    function applyBindingsToNodeInternal (node, bindings, viewModelOrBindingContext, bindingContextMayDifferFromDomParentElement) {
        ...
        ko.dependentObservable(
            function () {
                ...
                if (parsedBindings) {
                    // First run all the inits, so bindings can RegisterEntityToModelIdFunc for notification on changes
                    if (initPhase === 0) {
                        initPhase = 1;
